...
public class Solution {
    ...
    public int myAtoi(String str) {
        ...
        for (char c : toCharArray) {
            ...
            } else if (isPositiveAndNegativeSigns(c)) {
                if (stringBuilder.length() == 0) {
        ...
        if (stringBuilder.length() == 0) {
            return 0;
        } else if (stringBuilder.length() == 1 && isPositiveAndNegativeSigns(stringBuilder.charAt(0))) {
            return 0;
        }
     ...
     * @return
     */
    private boolean isPositiveAndNegativeSigns(char aChar) {
        return aChar == '-' || aChar == '+';
    }
     ...
     * @return
     */
    private boolean isNumberChar(char aChar) {
